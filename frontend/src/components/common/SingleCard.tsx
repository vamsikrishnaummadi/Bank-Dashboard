...
const SingleCard = (props: CreditCardItemProps) => {
  ...
  return (
    <div
      className={`rounded-[20px] border border-[#DFEAF2] ${containerClasses} flex flex-col justify-between w-[273px] h-[196px] shrink-0`}
