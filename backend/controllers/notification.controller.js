...
export const createNotification = async (req, res, next) => {
  ...
  try {
    ...
    next(new CustomError(500, "Failed to create notification"));
  }
};
...
export const getNotificationsByAccountNumber = async (req, res, next) => {
  ...
  try {
    ...
    next(new CustomError(500, "Failed to retrieve notifications"));
  }
};
...
export const updateNotification = async (req, res, next) => {
  ...
  try {
    ...
    next(new CustomError(500, "Failed to update notification"));
  }
};
...
export const deleteNotification = async (req, res, next) => {
  ...
  try {
    ...
    next(new CustomError(500, "Failed to delete notification"));
  }
};
